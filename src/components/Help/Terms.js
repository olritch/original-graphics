  ...
  render() {
    return (
      ...
      <p>Most of the modern day interactive web sites
	    ...
	    pages from http://originalgraphics.com for your own personal use subject to restrictions set in these terms and conditions.</p>
	    <p>You must not:</p>
	    <ol>
		  <li>Republish material from http://originalgraphics.com</li>
		  <li>Sell, rent or sub-license material from http://originalgraphics.com</li>
		  <li>Reproduce, duplicate or copy material from http://originalgraphics.com</li>
	    </ol>
	    <p>Redistribute content from Original Graphics (unless content is specifically made for redistribution).</p>
	...
	the visibility associated with the hyperlink outweighs the absence of ; and (d) where the link is in the context of general resource information or is otherwise consistent with editorial content
	...
	you must notify us by sending an e-mail to <a href="mailto:originalgraphics@gmail.com" title="send an email to originalgraphics@gmail.com">originalgraphics@gmail.com</a>.
	...
	<p>No use of Original Graphics’s logo or other artwork will be allowed for linking absent a trademark license
	agreement.</p>
