  ...
  render() {
    ...
    return (
      <div className="column" style={{ padding: '15px 5px 5px 5px' }}>
        <div className="column" style={{ padding: '20px 5px 5px 5px' }}>
          ...
          <Modal.Content>
            {errors.match && (
              <Message size="small" attached negative content={errors.match} />
            )}
            <form
            ...
            >
              <div className="ui stacked segment">
                ...
                <Segment>
                  <Recaptcha
                    sitekey="6LfiA4cUAAAAAIPWf25xQ1bAohV7SRFQ4rS-aSLc"
                    render="explicit"
                    size="normal"
                    theme="light"
